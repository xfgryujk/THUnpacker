...
void TH15Unpacker::formatIndex(vector<Index>& index, const BYTE* indexBuffer, int fileCount, DWORD indexAddress)
{
...
// see th15.exe.0046C4A7
bool TH15Unpacker::onUncompress(const Index& index, BYTE*& buffer, DWORD& size)
{
