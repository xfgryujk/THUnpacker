...
void TH10Unpacker::formatIndex(vector<Index>& index, const BYTE* indexBuffer, int fileCount, DWORD indexAddress)
{
...
// see th10.exe.00434E85
bool TH10Unpacker::onUncompress(const Index& index, BYTE*& buffer, DWORD& size)
{
