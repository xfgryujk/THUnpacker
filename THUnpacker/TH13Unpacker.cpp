...
void TH13Unpacker::formatIndex(vector<Index>& index, const BYTE* indexBuffer, int fileCount, DWORD indexAddress)
{
...
// see th13.exe.00457F75
bool TH13Unpacker::onUncompress(const Index& index, BYTE*& buffer, DWORD& size)
{
