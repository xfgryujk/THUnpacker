...
void TH12Unpacker::formatIndex(vector<Index>& index, const BYTE* indexBuffer, int fileCount, DWORD indexAddress)
{
...
// see th12.exe.0044B877
bool TH12Unpacker::onUncompress(const Index& index, BYTE*& buffer, DWORD& size)
{
